...
public class SimpleJsonUtil {
     ...
     * 从json HASH表达式中获取一个map，该map支持嵌套功能
     */
    public static Map<String, JSONObject> getMapJSONObject4Json(String jsonString) {
        return JSON.parseObject(jsonString, new TypeReference<Map<String, JSONObject>>() {
        });
    }
    ...
    public static String getCommonJson(int code, Object content) {
        ...
        return JSON.toJSONString(commonMap, SerializerFeature.PrettyFormat,
                SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.WriteNullStringAsEmpty, SerializerFeature.WriteDateUseDateFormat);
    }
     ...
     * @return
     */
    public static String getCommonJson(Object obj) {
